...
const animeData = {
  save: (fileKey, storageKey, data) =>
    ipcRenderer.invoke("save-anime-data", fileKey, storageKey, data),
  ...
  delete: (fileKey, storageKey, isSame = false) =>
    ipcRenderer.invoke("delete-anime-data", fileKey, storageKey, isSame),
}
