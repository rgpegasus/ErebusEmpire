...
export default function VideoPlayertflixPlayer({
  title = false,
  subTitle = false,
  titleMedia = false,
  ...
  const nextSeconds = (seconds: number) => {
    if (videoComponent.current) {
      ...
      if (current + seconds >= total - 2) {
        videoComponent.current.currentTime = total - 1;
  ...
  const getKeyBoardInteration = (e: KeyboardEvent) => {
    if (e.key === ' ' && videoComponent.current) {
      if (videoComponent.current.paused) {
        videoComponent.current.play();
        setPlaying(true);
        hoverScreen();
    ...
    if (e.key === 'ArrowUp') {
      e.preventDefault();
      if (videoComponent.current) {
        const currentVol = videoComponent.current.volume * 100;
          ...
          <div className="controlls">
            <div className="start">
              <div className="item-control">
                {!playing && <FaPlay onClick={play} onDoubleClick={(e) => e.stopPropagation()} />}
                {playing && <FaPause onClick={play} onDoubleClick={(e) => e.stopPropagation()} />}
              </div>

              <div className="item-control">
                <FaUndoAlt onClick={() => previousSeconds(5)} onDoubleClick={(e) => e.stopPropagation()}/>
              </div>

              <div className="item-control">
                <FaRedoAlt onClick={() => nextSeconds(10)} onDoubleClick={(e) => e.stopPropagation()}/>
              </div>
              ...
              {muted === false && (
                ...
                >
                    ...
                    <div className="volumn-controll">
                      ...
                      <div className="box">
                        <input
                          ...
                          min={0}
                          max={100}
                          value={videoComponent.current?.volume ? videoComponent.current.volume * 100 : volume}
                  ...
                  {volume >= 60 && (
                    <FaVolumeUp onMouseEnter={() => setShowControlVolume(true)} onClick={() => setMuttedAction(true)} onDoubleClick={(e) => e.stopPropagation()} />
                  )}
                  ...
                  {volume <= 0 && (
                    <FaVolumeMute onMouseEnter={() => setShowControlVolume(true)} onClick={() => setVolumeAction(0)} onDoubleClick={(e) => e.stopPropagation()} />
                  )}
                </VolumeControll>
              )}
              ...
              {muted === true && (
                <div className="item-control">
                  <FaVolumeMute onClick={() => setMuttedAction(false)} onDoubleClick={(e) => e.stopPropagation()} />
                </div>
              )}
            ...
            <div className="end">
                    ...
                    <ItemPlaybackRate>
                      <div>
                        ...
                        {playbackRateOptions.map(item => (
                          <div className="item"  onClick={() => onChangePlayBackRate(item) } onDoubleClick={(e) => e.stopPropagation()} >
              ...
              {onNextClick && (
                <div className="item-control" onMouseLeave={() => setShowDataNext(false)}>
                  {showDataNext === true && dataNext.title && (
                    <ItemNext>
                      <div>
                        ...
                        <div className="item" onClick={onNextClick} onDoubleClick={(e) => e.stopPropagation()} >
                  ...
                  <FaStepForward onClick={onNextClick} onDoubleClick={(e) => e.stopPropagation()} onMouseEnter={() => setShowDataNext(true)} />
                </div>
              )}
