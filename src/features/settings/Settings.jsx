    ...
    <div className="MainPage">
      ...
      <div className={styles.Container}>
          ...
          >
            <div className={styles.UserInfo}>
              ...
              <div className={styles.UserInfoContainer}>
                ...
                <div className={styles.DownloadDate}>Membre depuis  le {formatDate(downloadDate)}</div>
              </div>
            </div>
        ...
        <div className={styles.Group}>
          <div className={`${styles.Item} ${styles.Theme}`} onClick={openTheme}>
            <div className={styles.ItemContainer}>
              <div><ColorPaletteIcon className={styles.ItemIcon}/></div>
              <div className={styles.ItemInfo}>
                <span className={styles.ItemTitle}>Personnaliser le thème</span>
                <span className={styles.ItemSubTitle}>Choisissez l'apparence qui vous correspond</span>
              </div>
            </div>
            <span>
              <ChevronRight className={styles.ChevronIcon} />
          ...
          <div className={styles.Item}>
            <div className={styles.ItemContainer}>
              <div><PinIcon className={styles.ItemIcon}/></div>
              <div className={styles.ItemInfo}>
          ...
          <div className={styles.Item}>
            <div className={styles.ItemContainer}>
              <div><Bell className={styles.ItemIcon}/></div>
              <div className={styles.ItemInfo}>
        ...
        <div className={styles.Group}>
          <div className={styles.Item}>
            <div className={styles.ItemContainer}>
              <div><GrLanguage className={styles.ItemIcon}/></div>
              <div className={styles.ItemInfo}>
                <span className={styles.ItemTitle}>Langue favorite</span>
                <span className={styles.ItemSubTitle}>Choisissez votre langue préférée pour regarder des animés</span>
              </div>
            </div>
            <div  onClick={() => setLanguageDropdown(!languageDropdown)}>
              <div className={styles.DropdownButton}>
                <div>Français ({favoriteLanguage})</div>
                <div><ChevronDown /></div>
              </div>
              {languageDropdown && (
                <div className={styles.DropdownMenu}>     
                  <div className={`${styles.DropdownItem} ${favoriteLanguage == "vostfr" && styles.FavoriteLanguage}`} onClick={() => updateFavoriteLanguage("vostfr")}>Japonais (vostfr)</div>
                  <div className={`${styles.DropdownItem} ${favoriteLanguage == "vf" && styles.FavoriteLanguage}`} onClick={() => updateFavoriteLanguage("vf")}>Français (vf)</div>
                  <div className={`${styles.DropdownItem} ${favoriteLanguage == "va" && styles.FavoriteLanguage}`} onClick={() => updateFavoriteLanguage("va")}>Anglais (va)</div>
                </div>
              )}
            </div>
          </div>
        ...
        <div className={styles.Group}>
          <div className={styles.Item}>
            <div className={styles.ItemContainer}>
              <div><FaInfoCircle className={styles.ItemIcon}/></div>
              <div className={styles.ItemInfo}>
                <span className={styles.ItemTitle}>Besoin d'aide ?</span>
                <span className={styles.ItemSubTitle}>Consultez notre centre d'aide ou contactez notre support</span>
              </div>
            </div>
          </div>
        </div>
